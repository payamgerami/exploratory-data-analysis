...
p2 <- ggplot( aes( x = fixed.acidity), data = wine) +
  geom_histogram() +
  scale_x_log10()
p3 <- ggplot( aes( x = fixed.acidity, y = fixed.acidity), data = wine) +
  geom_boxplot()
grid.arrange(p1,p2,p3,ncol = 3)
```
...
p2 <- ggplot( aes( x = chlorides), data = wine) +
  geom_histogram() +
  xlim(0.05,0.2)
p3 <- ggplot( aes( x = chlorides, y = chlorides), data = wine) +
  geom_boxplot()
grid.arrange(p1,p2,p3,ncol = 3)
```
...
p2 <- ggplot( aes( x = free.sulfur.dioxide), data = wine) +
  geom_histogram() +
  scale_x_log10()
p3 <- ggplot( aes( x = free.sulfur.dioxide, y = free.sulfur.dioxide), data = wine) +
  geom_boxplot()
grid.arrange(p1,p2,p3,ncol = 3)
```
...
p2 <- ggplot( aes( x = density), data = wine) +
  geom_histogram() +
  xlim(0.9956, 0.9978)
p3 <- ggplot( aes( x = density, y = density), data = wine) +
  geom_boxplot()
grid.arrange(p1,p2,p3,ncol = 3)
```
...
p2 <- ggplot( aes( x = sulphates), data = wine) +
  geom_histogram() +
  scale_x_log10()
p3 <- ggplot( aes( x = sulphates, y = sulphates), data = wine) +
  geom_boxplot()
grid.arrange(p1,p2,p3,ncol = 3)
```
...
ggplot(aes(x = quality.bucket, y = volatile.acidity, color = quality.bucket), 
       data = wine) +
  geom_jitter(alpha = 0.5, size = 2)  +
  geom_boxplot( alpha = .5,color = 'blue') +
  stat_summary(fun.y = "mean", 
...
### Plot Three
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height=5, fig.width=9}
ggplot(aes(x = quality.bucket, y = alcohol, color = quality.bucket), 
       data = wine) +
  geom_jitter(alpha = 0.5, size = 2)  +
  geom_boxplot( alpha = .5,color = 'blue') +
  stat_summary(fun.y = "mean", 
